class Artestead
  def Artestead.configure(config, settings)
    ...
    # Local Machine Hosts (vagrant-hostsupdater plugin for Vagrant must be installed)
    ...
    # Disabled due to errors when behind proxy server 
    # config.vm.provision "shell" do |s|
